...
`probe()` sets `error="524"` for Cloudflare 524, `"timeout"` for timeout, `"connection_error"` for network errors. 524 is distinguished per integration spec landmine L4 (`lb.py:217–225`).
