...
- **Spec §16 Milestone 3:** Stand up first custom vLLM serverless endpoint
- **Spec §3.3:** OpenAI-Compatible Serverless
- **Spec §4.1 L5:** LB endpoint creation is console-only
- **Spec §4.1 L9:** FlashBoot runpodctl regression
